                ...
                >
                    <div class="h-full bg-white dark:bg-[#0e1726]">
                        <div class="flex items-center justify-between px-4 py-3">
                            <a href="<?php echo base_url()?>Dashboard" class="main-logo flex shrink-0 items-center">
                                <img class="ml-[5px] w-8 flex-none" src="<?php echo base_url('assets/images/logo.svg'); ?>" alt="image" />
                                <span class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">POS TOKO</span>
                            </a>
                        ...
                        >
                            <a href="<?php echo base_url()?>Dashboard" class="group">
                            ...
                            <li class="nav-item">
                                <ul>
                                    <li class="nav-item">
                                                <a href="<?php echo base_url()?>Masterdata/product" class="group">
                                                    <div class="flex items-center">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Produk</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                                <a href="<?php echo base_url()?>Masterdata/Customer" class="group">
                                                    <div class="flex items-center">
                                                           <svg class="shrink-0 group-hover:!text-primary"  width="20" height="20" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <ellipse cx="9.00098" cy="17.001" rx="7" ry="4" fill="currentColor" />
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Customer</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                                <a href="<?php echo base_url()?>Masterdata/Supplier" class="group">
                                                    <div class="flex items-center">
                                                     <svg class="shrink-0 group-hover:!text-primary"  width="20" height="20" viewBox="0 0 24 24" fill="none">
                                            <circle opacity="0.5" cx="15" cy="6" r="3" fill="currentColor" />
                                            <ellipse opacity="0.5" cx="16" cy="17" rx="5" ry="3" fill="currentColor" />
                            ...
                            <li class="menu nav-item">
                                <a href="<?php echo base_url('Pos') ?>" class="nav-link group">
                                    <div class="flex items-center">
                                        <svg
                                            class="shrink-0 group-hover:!text-primary"
                                            width="20"
                            ...
                            <li class="menu nav-item">
                                <a href="<?php echo base_url('Pos/transactionlist'); ?>" class="nav-link group">
                                    <div class="flex items-center">
                                         <svg
                                            class="shrink-0 group-hover:!text-primary"
                                            width="20"
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">List Penjualan</span>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li class="menu nav-item">
                                <a href="<?php echo base_url('Payment/supplier_debt'); ?>" class="nav-link group">
                                    <div class="flex items-center">
                                        <svg
                                            class="shrink-0 group-hover:!text-primary"
                                            width="20"
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Hutang Supplier</span>
                                    </div>
                                </a>
                            </li>

                            <li class="menu nav-item">
                                <a href="<?php echo base_url('Payment/customer_receivable'); ?>" class="nav-link group">
                                    <div class="flex items-center">
                                         <svg
                                            class="shrink-0 group-hover:!text-primary"
                                            width="20"
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Piutang Customer</span>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li class="menu nav-item">
                                <a href="<?php echo base_url('report/income') ?>" class="nav-link group">
                                    <div class="flex items-center">
                                        <svg
                                            class="shrink-0 group-hover:!text-primary"
                                            width="20"
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Laporan Penjualan</span>
                                    </div>
                                </a>
                            </li>

                            <li class="menu nav-item">
                                <a href="<?php echo base_url('report/reportreceivable') ?>" class="nav-link group">
                                    <div class="flex items-center">
                                        <svg
                                            class="shrink-0 group-hover:!text-primary"
                                            width="20"
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Laporan Piutang Pelanggan</span>
                                    </div>
                                </a>
                            </li>

                            <li class="menu nav-item">
                                <a href="<?php echo base_url('report/reportdebt') ?>" class="nav-link group">
                                    <div class="flex items-center">
                                        <svg
                                            class="shrink-0 group-hover:!text-primary"
                                            width="20"
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Laporan Hutang Supplier</span>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li class="menu nav-item">
                                <a href="<?php echo base_url(); ?>Utility/unit" class="nav-link group">
                                    <div class="flex items-center">
                                        <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none">
                                            <path
                                                opacity="0.5"
                                                d="M12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 二十.5355C19.0711  twenty 16.714  twenty 12  twenty Z"
                                                fill="currentColor"
                                            />
                                            <path
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Unit</span>
                                    </div>
                                </a>
                            </li>

                            <li class="menu nav-item">
                                <a href="<?php echo base_url(); ?>Utility/category" class="nav-link group">
                                    <div class="flex items-center">
                                        <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none">
                                            <path
                                                opacity="0.5"
            ...
            <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                    <a href="index.html" class="main-logo flex shrink-0 items-center">
                        <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="<?php echo base_url('assets/images/logo.svg'); ?>" alt="image" />
                        <span
...
<div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
    <a href="javascript:;" class="group relative" @click="toggle()">
        ...
        src="<?php echo base_url('assets/images/user-profile.jpeg'); ?>"
        alt="image"
        /></span>
    </a>
    <ul
    ...
    <li>
        <div class="flex items-center px-4 py-4">
            <div class="flex-none">
                <img class="h-10 w-10 rounded-md object-cover" src="<?php echo base_url('assets/images/user-profile.jpeg'); ?>" alt="image" />
            </div>
            <div class="truncate ltr:pl-4 rtl:pr-4">
                <h4 class="text-base">
                <?php echo $_SESSION['user_name']; ?>
                    <span class="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2">AKTIF</span>
                </h4>
            </div>
        </div>
    </li>
    ...
    <li class="border-t border-white-light dark:border-white-light/10">
        <a href="<?php echo base_url('auth/logout'); ?>" class="!py-3 text-danger" @click="toggle">
            <svg
