...
<div class="animate__animated p-6" :class="[$store.app.animation]">
	...
	<div class="panel mt-6">
		<div class="px-5">
            ...
            <div id="report">
                <iframe id="preview" src="<?php echo base_url(); ?>Report/reportreceivablepdf" width="100%" height="1000px"></iframe>
            </div>
...
// handle search and update iframe & download link
    ...
    $('#btnsearch').click(function(e) {
      ...
      let url = '<?php echo base_url(); ?>Report/reportreceivablepdf?';
    ...
    $('#btndownloadexcell').click(function(e) {
      ...
      let url = '<?php echo base_url(); ?>Report/reportreceivableexcell?';
      url += 'start_date=' + start_date;
      url += '&end_date=' + end_date;
