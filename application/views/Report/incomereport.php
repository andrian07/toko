		...
		<div class="px-5">
			...
			<div class="flex items-center justify-between mb-3">
				...
				<div class="flex items-center gap-2">
					<a id="btndownloadexcell" href="<?php echo base_url(); ?>Report/reportincomepdf" class="btn btn-success gap-2" target="_blank">
            ...
            <div id="report">
                <iframe id="preview" src="<?php echo base_url(); ?>Report/reportincomepdf" width="100%" height="1000px"></iframe>
            </div>
...
// handle search and update iframe & download link
    ...
    $('#btnsearch').click(function(e) {
      ...
      let url = '<?php echo base_url(); ?>Report/reportincomepdf?';
    ...
    $('#btndownloadexcell').click(function(e) {
      ...
      let url = '<?php echo base_url(); ?>Report/reportincomeexcell?';
      url += 'start_date=' + start_date;
      url += '&end_date=' + end_date;
